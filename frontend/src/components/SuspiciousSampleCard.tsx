    ...
    <>
      ...
      >
        ...
        <CardContent>
          <div className="space-y-3">
            ...
            {/* Signal badges */}
            {detection.signal_breakdown &&
              (() => {
                let parsed: Record<string, any> = {};
                try {
                  parsed = JSON.parse(detection.signal_breakdown);
                } catch {}
                const dominant = parsed.dominant_signal;
                const mismatch = parsed.label_mismatch;
                return (
      ...
      <Dialog open={detailsOpen} onOpenChange={setDetailsOpen}>
        <DialogContent className="max-w-2xl max-h-[90vh] overflow-y-auto">
          <DialogHeader>
            <DialogTitle>
              Sample #{detection.sample_id} - Detection Details
            </DialogTitle>
            <DialogDescription>
                      ...
                      <div className="flex items-center gap-2">
                        <div className="w-32 bg-gray-200 rounded-full h-2">
                          <div
                            ...
                            style={{
                              width: `${details.confidence_score * 100}%`,
                            }}
                          />
                        </div>
                      ...
                      <div className="flex items-center gap-2">
                        <div className="w-32 bg-gray-200 rounded-full h-2">
                          <div
                            ...
                            style={{
                              width: `${details.priority_score * 100}%`,
                            }}
                          />
                        </div>
                        <span className="text-sm font-semibold">
                  ...
                  <div className="flex items-start gap-3">
                    ...
                    <div>
                      ...
                      <p className="text-sm text-blue-800 mt-1">
                        ...
                        {(details.confidence_score * 100).toFixed(1)}%) and
                        anomaly detection, this sample should be reviewed. The
                        model predicts Class {details.predicted_label} instead
                        of the current Class {details.current_label}.
                      </p>
                    </div>
                  </div>
                </CardContent>
